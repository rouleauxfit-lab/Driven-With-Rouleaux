...
function LogoMark({ className = "" }) {
  return (
    <div className={`relative grid place-items-center ${className}`} aria-label="Drive With Rouleaux logo">
      <div className="absolute inset-0 rounded-[1.35rem] bg-orange-500 opacity-50 blur-md" />
      <div className="relative grid h-full w-full rotate-[-3deg] place-items-center rounded-[1.35rem] border border-white/20 bg-gradient-to-br from-white to-orange-100 text-zinc-950 shadow-xl shadow-orange-500/20">
        <svg viewBox="0 0 64 64" className="h-[70%] w-[70%]" fill="none" aria-hidden="true">
          <path d="M11 40h42" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
          <path d="M16 39l3.7-14.2A6 6 0 0 1 25.5 20h13a7 7 0 0 1 6.3 4l4.2 9.2 4 1.8v4" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M23 20l-3 8h25" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
          <circle cx="22" cy="42" r="6" stroke="currentColor" strokeWidth="4" />
          <circle cx="45" cy="42" r="6" stroke="currentColor" strokeWidth="4" />
          <path d="M31 13l3 5 5-3" stroke="#f97316" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </div>
    </div>
  );
...
function Button({ children, type = "button", variant = "primary", className = "", onClick, disabled = false }) {
  ...
  const styles =
    variant === "outline"
      ...
      : "bg-orange-500 text-white shadow-lg shadow-orange-500/20 hover:-translate-y-0.5 hover:bg-orange-600";
...
function HeroPortrait() {
  ...
  return (
    <div className="relative z-10 flex min-h-[520px] w-full items-center justify-center rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-zinc-900 via-zinc-950 to-orange-950/40 p-8 text-center shadow-[0_35px_120px_rgba(0,0,0,0.55)]">
      <div>
        <LogoMark className="mx-auto h-24 w-24" />
        <p className="mt-6 text-sm font-black uppercase tracking-[0.2em] text-orange-400">Photo slot ready</p>
...
export default function App() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setStatus({
        type: "success",
        message: "Got it. Your request was sent and I’ll reach out shortly with the next move.",
      });
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-zinc-950 text-white">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_10%,rgba(249,115,22,0.22),transparent_35%),radial-gradient(circle_at_80%_25%,rgba(251,146,60,0.12),transparent_30%)]" />
        <div className="absolute -top-32 left-1/2 h-[30rem] w-[30rem] -translate-x-1/2 animate-pulse rounded-full bg-orange-500/25 blur-3xl" />
        <div className="absolute top-80 right-0 h-96 w-96 rounded-full bg-sky-500/10 blur-3xl" />
        <div className="absolute bottom-0 left-0 h-[28rem] w-[28rem] rounded-full bg-orange-400/10 blur-3xl" />
        <div className="absolute left-1/2 top-[34rem] h-[38rem] w-[38rem] -translate-x-1/2 rounded-full border border-white/10" />
        <div className="absolute left-1/2 top-[36rem] h-[24rem] w-[24rem] -translate-x-1/2 rounded-full border border-orange-400/10" />
        ...
        <div className="absolute left-0 right-0 top-32 h-px bg-gradient-to-r from-transparent via-orange-400/30 to-transparent" />
        <div className="absolute -left-24 top-[18rem] h-2 w-[38rem] rotate-[-12deg] rounded-full bg-orange-500/20 blur-md" />
      ...
      <header className="relative z-10 mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-6">
        ...
        <button type="button" onClick={scrollToContact} className="inline-flex items-center justify-center gap-2 rounded-2xl bg-orange-500 px-5 py-2 text-sm font-black text-white shadow-lg shadow-orange-500/20 transition hover:-translate-y-0.5 hover:bg-orange-600 active:scale-[0.98]">
          Get Help
        </button>
      </header>
      ...
      <main className="relative z-10">
        <section className="relative mx-auto grid max-w-6xl items-center gap-12 px-5 pb-16 pt-10 lg:grid-cols-[1fr_.95fr] lg:pt-24">
          <div className="absolute right-0 top-10 hidden h-40 w-40 rounded-full border border-orange-400/10 lg:block" />
          <div className="relative z-10">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-zinc-300 shadow-2xl shadow-orange-500/10 backdrop-blur">
              <Icon name="spark" className="h-4 w-4 text-orange-400" />
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <button type="button" onClick={scrollToContact} className="inline-flex items-center justify-center gap-2 rounded-2xl bg-orange-500 px-6 py-3 text-base font-black text-white shadow-lg shadow-orange-500/20 transition hover:-translate-y-0.5 hover:bg-orange-600 active:scale-[0.98]">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              {TRUST_POINTS.map((point) => (
                <div key={point} className="rounded-full border border-orange-400/20 bg-orange-500/10 px-4 py-2 text-sm font-semibold text-orange-50 shadow-lg shadow-orange-950/10">
                  {point}
                </div>
              ))}
            </div>
          ...
          <div className="relative flex flex-col items-stretch justify-center gap-6 lg:translate-y-4">
            <div className="absolute inset-0 rounded-[3rem] bg-gradient-to-t from-orange-500/10 via-transparent to-transparent blur-2xl" />
            <div className="absolute -left-8 top-10 z-20 rounded-2xl border border-white/10 bg-zinc-950/75 px-4 py-3 text-xs font-black uppercase tracking-[0.18em] text-orange-300 shadow-2xl shadow-black/40 backdrop-blur">
              Drive With Rouleaux
            </div>
            <HeroPortrait />
            ...
            <Card className="relative z-20 w-full overflow-hidden border border-white/10 bg-gradient-to-b from-zinc-950/95 to-zinc-900/90 shadow-[0_25px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl">
              <div className="absolute -right-20 bottom-8 h-48 w-48 rounded-full bg-orange-500/20 blur-3xl" />
              <div className="absolute inset-x-6 top-6 h-px bg-gradient-to-r from-transparent via-white/20 to-transparent" />
              <div className="absolute right-5 top-5 rounded-2xl bg-orange-500 px-4 py-2 text-sm font-black text-white shadow-xl shadow-orange-500/20">
                Free help
              </div>
              <div className="relative p-7">
                <div className="relative rounded-[1.5rem] bg-zinc-950/80 p-5">
                  <div className="mb-5 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold uppercase tracking-[0.2em] text-orange-400">Lead magnet</p>
                  ...
                  <h2 className="mt-3 max-w-sm text-3xl font-black leading-none tracking-tight sm:text-4xl">
                    Free auto game plan
                    <span className="block text-orange-400">built around your move.</span>
                  </h2>
                  <p className="mt-3 max-w-md text-zinc-300">Send the basics and I’ll help you figure out the cleanest path.</p>
                  <button type="button" onClick={handleLeadMagnetClick} className="mt-5 inline-flex items-center justify-center gap-2 rounded-2xl bg-orange-500 px-5 py-3 text-sm font-black text-white shadow-lg shadow-orange-500/20 transition hover:-translate-y-0.5 hover:bg-orange-600 active:scale-[0.98]">
        ...
        <section className="mx-auto grid max-w-6xl gap-5 px-5 py-12 md:grid-cols-3">
          {FEATURE_CARDS.map((item) => (
            <Card key={item.title} className="group relative overflow-hidden border-white/10 bg-gradient-to-b from-white/[0.07] to-white/[0.03] text-white transition duration-300 hover:-translate-y-2 hover:border-orange-400/30 hover:bg-white/[0.09] hover:shadow-2xl hover:shadow-orange-950/20">
              <div className="absolute right-0 top-0 h-24 w-24 rounded-full bg-orange-500/10 blur-2xl" />
              <div className="relative p-7">
                <div className="mb-5 grid h-12 w-12 place-items-center rounded-2xl bg-orange-500/10 text-orange-400 transition group-hover:bg-orange-500 group-hover:text-white">
                  <Icon name={item.icon} className="h-7 w-7" />
                </div>
                <h3 className="text-xl font-black">{item.title}</h3>
                <p className="mt-3 leading-7 text-zinc-300">{item.text}</p>
                <button type="button" onClick={() => handleFeatureAction(item)} className="mt-6 inline-flex items-center justify-center gap-2 rounded-2xl border border-orange-400/30 bg-orange-500/10 px-4 py-2 text-sm font-black text-orange-200 transition hover:bg-orange-500 hover:text-white active:scale-[0.98]">
        ...
        <section id="process" className="mx-auto max-w-6xl px-5 py-16">
          <div className="grid gap-6 lg:grid-cols-[1fr_.9fr]">
            <div className="rounded-[2.5rem] border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.03] p-8 shadow-[0_24px_80px_rgba(0,0,0,0.25)] backdrop-blur">
              <p className="text-sm font-black uppercase tracking-[0.2em] text-orange-400">How this works</p>
              <h2 className="mt-3 text-3xl font-black">A smoother way to shop for a car.</h2>
              <div className="mt-8 space-y-6">
                {STEPS.map((step, index) => (
                  <div key={step.title} className="flex gap-4">
                    <div className="grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-orange-500 font-black text-white shadow-lg shadow-orange-500/20">{index + 1}</div>
                    <div>
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-orange-400/20 bg-gradient-to-br from-orange-500/20 via-orange-400/10 to-zinc-900 p-8 shadow-2xl shadow-orange-950/20">
              <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full border border-white/10" />
              <p className="text-sm font-black uppercase tracking-[0.2em] text-orange-200">Why people hate buying cars</p>
              <h2 className="mt-3 text-3xl font-black text-white">Too much noise. Too little honesty.</h2>
              <p className="mt-5 leading-8 text-orange-50/90">Most people walk into the process already stressed. Too many numbers. Too many opinions. Too many “limited-time deals” flying around like confetti from a financial cannon.</p>
              <p className="mt-4 leading-8 text-orange-50/80">This site is meant to feel different. Cleaner. More direct. More like texting somebody who actually knows the game.</p>
            </div>
          </div>
        </section>
        ...
        <section id="contact" className="mx-auto max-w-6xl px-5 pb-10 pt-6">
          <div className="grid gap-6 lg:grid-cols-[.8fr_1.2fr]">
            <div>
              <p className="text-sm font-bold uppercase tracking-[0.2em] text-orange-400">Start here</p>
              ...
              <div className="mt-6 space-y-3 text-sm text-zinc-300">
                <p className="flex items-center gap-3"><Icon name="phone" className="h-4 w-4 text-orange-400" /> Call/Text: add your number here</p>
                <p className="flex items-center gap-3"><Icon name="mail" className="h-4 w-4 text-orange-400" /> {INBOX_EMAIL}</p>
              </div>
            </div>

            <Card className="overflow-hidden border-white/10 bg-white text-zinc-950 shadow-[0_25px_80px_rgba(0,0,0,0.35)]">
              <div className="h-2 bg-gradient-to-r from-orange-500 via-orange-300 to-orange-500" />
              <form onSubmit={handleSubmit} className="relative p-6 md:p-8">
                ...
                <div className="mb-5 rounded-2xl bg-zinc-950 p-4 text-white">
                  <p className="text-xs font-black uppercase tracking-[0.2em] text-orange-400">Private lead request</p>
                  <p className="mt-1 text-sm text-zinc-300">No pressure. No spam. Just the info needed to help you move smart.</p>
                </div>

                <div className="grid gap-4 md:grid-cols-2">
                  <input name="name" value={form.name} onChange={handleChange} placeholder="Name" autoComplete="name" className="rounded-2xl border border-zinc-200 px-4 py-3 outline-none focus:border-orange-500" />
                  <input name="phone" value={form.phone} onChange={handleChange} placeholder="Phone" autoComplete="tel" className="rounded-2xl border border-zinc-200 px-4 py-3 outline-none focus:border-orange-500" />
                  <input name="email" value={form.email} onChange={handleChange} placeholder="Email" autoComplete="email" className="rounded-2xl border border-zinc-200 px-4 py-3 outline-none focus:border-orange-500" />
                  <select name="shoppingFor" value={form.shoppingFor} onChange={handleChange} className="rounded-2xl border border-zinc-200 px-4 py-3 outline-none focus:border-orange-500">
                  ...
                  <input name="vehicle" value={form.vehicle} onChange={handleChange} placeholder="Vehicle wanted" className="rounded-2xl border border-zinc-200 px-4 py-3 outline-none focus:border-orange-500" />
                  <input name="budget" value={form.budget} onChange={handleChange} placeholder="Budget or payment goal" className="rounded-2xl border border-zinc-200 px-4 py-3 outline-none focus:border-orange-500" />
                  <select name="timing" value={form.timing} onChange={handleChange} className="rounded-2xl border border-zinc-200 px-4 py-3 outline-none focus:border-orange-500">
                  ...
                  <input name="trade" value={form.trade} onChange={handleChange} placeholder="Trade-in vehicle, if any" className="rounded-2xl border border-zinc-200 px-4 py-3 outline-none focus:border-orange-500" />
                  ...
                  <textarea name="message" value={form.message} onChange={handleChange} placeholder="Anything else I should know?" rows={5} className="rounded-2xl border border-zinc-200 px-4 py-3 outline-none focus:border-orange-500 md:col-span-2" />
                </div>

                {status.message && (
                  <div className={`mt-5 rounded-2xl p-4 text-sm font-semibold ${status.type === "error" ? "bg-red-50 text-red-700" : status.type === "loading" ? "bg-orange-50 text-orange-700" : "bg-emerald-50 text-emerald-700"}`}>
                    {status.message}
                  </div>
                )}
        ...
        <section className="mx-auto max-w-6xl px-5 py-10">
          <div className="grid gap-6 rounded-[2.5rem] border border-white/10 bg-white/[0.04] p-6 backdrop-blur md:p-8 lg:grid-cols-[.75fr_1.25fr]">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.2em] text-orange-400">Weekly drop</p>
        ...
        <section className="mx-auto max-w-6xl px-5 py-12">
          <div className="relative overflow-hidden rounded-[2.5rem] border border-orange-400/20 bg-orange-500 p-8 text-zinc-950 shadow-[0_25px_80px_rgba(249,115,22,0.25)] md:p-10">
        ...
        <section id="questions" className="mx-auto max-w-6xl px-5 pb-24">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 backdrop-blur md:p-8">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                <p className="text-sm font-black uppercase tracking-[0.2em] text-orange-400">Questions</p>
            ...
            <div className="mt-8 space-y-4">
              {FAQS.map((faq) => (
                <div key={faq.question} className="rounded-2xl border border-white/10 bg-zinc-950/40 p-5 transition hover:border-orange-400/30">
        ...
        <div className="fixed bottom-5 left-1/2 z-50 w-[92%] max-w-xl -translate-x-1/2 rounded-[1.7rem] border border-orange-400/20 bg-zinc-950/80 p-4 shadow-[0_20px_60px_rgba(0,0,0,0.55)] backdrop-blur-2xl">
          <div className="flex items-center justify-between gap-4">
            ...
            <button type="button" onClick={scrollToContact} className="inline-flex shrink-0 items-center justify-center gap-2 rounded-2xl bg-orange-500 px-5 py-2 text-sm font-black text-white shadow-lg shadow-orange-500/20 transition hover:-translate-y-0.5 hover:bg-orange-600 active:scale-[0.98]">
              Start Here
            </button>
          </div>
        </div>
